      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-start relative z-10">
        ...
        >
          ...
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=bylancetechnologies@gmail.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-xl border border-white/8 bg-[#0f0f0f] hover:border-teal-500/30 hover:bg-teal-500/5 transition-all duration-200 group">
            ...
            <div>
              <p className="text-white/30 text-xs uppercase tracking-wider mb-0.5 group-hover:text-teal-400/60 transition-colors">Email us</p>
              <p className="text-white/80 text-sm group-hover:text-white transition-colors">bylancetechnologies@gmail.com</p>
            </div>
          </a>
            ...
            <ul className="flex flex-col gap-2.5">
              ...
              <li>
                <a href="https://www.linkedin.com/company/bylance-technologies/about/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-white/50 hover:text-blue-400 text-sm transition-colors">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                  LinkedIn
                </a>
              </li>
            </ul>
